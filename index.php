    ...
    <header class="clearfix">
      ...
      <div>
        ...
        <div id="share-app">
          ...
          <ul>
            <li>
              <a href="http://facebook.com/kartoenbitjara.indonesia" class="facebook-button" id="postToWall" data-url="<?php echo AppInfo::getUrl(); ?>">
                <span class="plus">Tulis di dinding</span>
              </a>
            </li>
            <li>
    ...
    <section id="guides" class="clearfix">
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            Didirikan pada 2008, Yayasan KI (Kartoenbitjara Indonesia) adalah sebuah lembaga yang melakukan pembelajaran, pemberdayaan, dan pengembangan masyarakat sipil di Indonesia.
          </p>
        </li>
        <li>
          <a href="http://kartoenbitjara.or.id/program/" target="blank"><img onmouseover="this.src='http://kartoenbitjara.or.id/wp-content/uploads/2012/08/KIFprogram2.png'" onmouseout="this.src='http://kartoenbitjara.or.id/wp-content/uploads/2012/08/KIFprogram3.png'" src="http://kartoenbitjara.or.id/wp-content/uploads/2012/08/KIFprogram3.png" alt="" /></a>
          <p>
            Media sosialisasi seluruh program Yayasan KI, termasuk laporan keuangan setiap program atau proyek. KIFprogram dapat diakses secara terbuka oleh publik.
          </p>
        </li>
        <li>
          <a href="#"><img onmouseover="this.src='http://kartoenbitjara.or.id/wp-content/uploads/2012/08/KIFsms2.png'" onmouseout="this.src='http://kartoenbitjara.or.id/wp-content/uploads/2012/08/KIFsms3.png'" src="http://kartoenbitjara.or.id/wp-content/uploads/2012/08/KIFsms3.png" alt="" /></a>
          <p>Media yang dibangun untuk menghubungkan informasi kepada publik. KIFsms diintegrasikan pada <a href="http://riset.crowdmap.com/" target="blank">Riset Akses Terbuka</a> dan/atau <a href="http://info.or.id/" target="blank">Info.or.id</a>.</p>
        </li>
      </ul>
    </section>
  </body>
